...
from cryptography.hazmat.primitives.asymmetric.ec import SECP256R1, ECDSA # type: ignore
from cryptography.hazmat.primitives.hashes import SHA256, SHA384, SHA512 # type: ignore
